    ...
    <footer className="sm:text-base w-full border-t-2 border-solid font-medium text-lg dark:border-light border-dark dark:text-light text-dark">
        <Layout className='py-8 flex items-center justify-between lg:flex-col lg:py-6'>
            ...
            <div className="lg:py-2"> 
                Build with <span className='text-primary dark:text-primaryDark text-2x1 px-1'> &#9825; </span> by &nbsp; <Link target={"_blank"} href="https://devdreaming.com" className='underline underline-offset-2'>Faxraddin</Link>
            </div>
